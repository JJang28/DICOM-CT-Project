...
def update_object_material(self, context: bpy.types.Context) -> None:
    ...
    modality = getattr(props, "imaging_modality", "CT")
    apply_material_intensity(self, modality)


class DICOMatorProperties(bpy.types.PropertyGroup):
    """Properties exposed in the DICOMator UI (CT-only)."""
    ...
    imaging_modality: bpy.props.EnumProperty(
        ...
        description="Only CT is supported",
        items=[("CT", "CT", "CT modality")],
        default="CT",
    ...
    ring_radius: bpy.props.FloatProperty(
        ...
        description="Relative radius of the ring (0=center, 1=edge)",
        default=0.5,
        min=0.0,
        max=1.0,
        precision=3,
    ...
    ring_thickness: bpy.props.FloatProperty(
        ...
        description="Relative radial thickness of the ring",
        default=0.02,
        min=0.0,
        soft_max=0.1,
        precision=3,
